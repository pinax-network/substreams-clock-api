...
export const DEFAULT_DB_TABLE = "Clock";
...
const CommanderSchema = z.object({
    ...
    name: z.string().default(DEFAULT_DB_TABLE),
...
const opts = new Command()
    ...
    .addOption(new Option("--name <string>", "Clickhouse DB table name").default(DEFAULT_DB_TABLE).env("DB_TABLE"))
